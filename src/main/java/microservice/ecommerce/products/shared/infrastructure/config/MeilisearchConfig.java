package microservice.ecommerce.products.shared.infrastructure.config;
...
@Configuration
@EnableMeilisearchRepositories(basePackages = {
    "microservice.ecommerce.products.product.infrastructure.persistence.repository.meilisearch",
    "microservice.ecommerce.products.category.infrastructure.persistence.repository.meilisearch"
})
